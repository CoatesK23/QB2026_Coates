...
rm(list=ls())
getwd()
setwd("C:/Users/coatesk23/OneDrive - East Carolina University/Documents/QuantBio/QB2026_Coates/BetaDiv")
...
> ***Answer 2a***: There is high species richness at downstream sites between the 0-75km transect of the river and at the bend of the river between the 150 and 200km transect.
> ***Answer 2b***:  There is greater abundance of trout upstream. 
> ***Answer 2c***:  These patterns show that richness overlooks community structure. 
...
> ***Answer 3a***:  The local (alpha) diversity varies at each site: upstream sites have fewer species, river-bend sites have the highest richness, and richness declines again downstream.In the Doubs, beta divesity is high, because many species are restricted to sections of the river which increases gamma diversity.
> ***Answer 3b***:  Site 1 was more similar to site 2, hosting more similar species, likely because the habitat shapes what fish are in each section of the river. 
> ***Answer 3c***:  The additive definition treats species as a unit and emphasizes species accumulation when scaling from local to regional, where the multiplicative definition emphasizes the turnover between sites by highlighting the proportion of species at each site .
...
> ***Answer 4***: Incidence focuses on presence/ absence so it can overrepresent rare species. Abundance metrics underrepresent rare species.   
...
> ***Answer 5a***:  It represents a dissimilarity matrix because the number of species at each site are very different, and the bray curtis dissimilarity values are different. Several values in fish.db are between 0.5 and 0.98, indicating very dissimilar communities.  
> ***Answer 5b***: The fish.db matrix made with Bray-Curtis makes sites look more dissimilar than Jaccard. 
...
> ***Answer 6***: I would hypothesize that the shape and flow of the Doubs river influences fish habitat and thus fish species diversity. 
...
explainvar3 <- round(fish.pcoa$eig[3] / sum(fish.pcoa$eig),
                     3) * 100
...
> ***Answer 7a***:  The groupings of community composition are influenced by the sampling location on the river. Sites 30-26 which are relatively downstream, 16-22 at the bend of the river, and 1-8 which are upstream have similar community compositions. 
> ***Answer 7b***: Environmental conditions such as nutrient availability, dissolved oxygen, and prey availability will vary along the river, shaping community composition. Competition among and between abundant species will also play a role in shaping community structure.     

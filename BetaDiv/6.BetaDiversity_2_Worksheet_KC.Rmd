...
author: "Kelsey Coates; QB 2026
date: "`r format(Sys.time(), '%17 %2, %2026')`"
output: pdf_document
...
> ***Answer 1***: 
The adonis permanova shows that the habitat quality is significantly influential on fish species composition. The high quality sites have a small but distinct set of specialist species, while the low quality sites have generalist species. Low quality and moderate quality sites hosted similar species, so the quality of the habitat influences what species (tolerant, specialist, generalist) can exist. The permanova, IndVal, and Phi analyses support each other. 
...
> ***Answer 2***:  The mantel test shows that the environmental conditions are significantly related to the fish species distribution which supports the hypothesis that fish communities are highly influenced by habitat quality. 
...
> ***Answer 3***: The oxygen and nitrogen availability are important environmental variables shaping fish community structure. 
...
> ***Answer 4***: The physical space of the river (sites) influences the fish community structure more than environmental factors like nutrient and oxygen availability alone. Although the combined site and environmental factors explain a greater amount of variaion in fish diversity more than environmental or spatial factors alone. 
